...
def show_error_val(guesses: list, test_set: SinglesData, feature_name, selector_name):
    """ Print WER and classification results in shorthand form
    ...
    print("{} | {} = WER: {}, Correct: {} out of {}".format(feature_name, 
                                                            selector_name, 
                                                            float(S) / float(N),
                                                            N - S, N))
